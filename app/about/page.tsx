...
export default function AboutPage() {
  ...
  return <><JsonLd data={schema} /><SiteHeader /><main>
    <header className="about-hero content-shell"><div><Breadcrumbs items={[{ label: "Home", href: "/" }, { label: "About" }]} /><span className="section-kicker">Real people · Real brand photography · Gold Coast only</span><h1>A cleaning business designed to feel clear, calm and local.</h1><p><strong>LAP Cleaning Services is a Gold Coast cleaning business for homes, workplaces, rental handovers and short-stay properties.</strong> The photography on this website was supplied for LAP and reflects the warm, careful presentation behind the brand.</p><Link className="button button-primary" href="/#quote">Get my free quote</Link></div><Image src="/images/lap-cleaning-team-gold-coast.jpg" alt="LAP Cleaning Services professional on the Gold Coast" width={900} height={1125} priority sizes="(max-width: 900px) 100vw, 44vw" /></header>
    <section className="about-story content-shell"><div><span className="section-kicker">The LAP story</span><h2>A newer cleaning business with a growing circle of happy clients.</h2></div><div><p>LAP Services started recently on the Gold Coast with a simple goal: make professional cleaning feel personal, clear and easy to organise.</p><p>Since opening, the team has already helped more than 100 happy clients across homes, workplaces, rental handovers and short-stay properties. Every enquiry still starts with the individual property, the preferred timing and the result you want.</p><p>LAP’s warm beige-and-brown identity reflects the calm, careful presentation behind the service. Choose the closest cleaning option and the team can clarify the right scope for your Gold Coast property.</p></div></section>
